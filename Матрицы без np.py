...
if action in '2':
    ...
    if n == 2:
        ...
        if A[0].count(0) == 3 and A[1].count(0) == 3 and A[2].count(0) == 3:
            ...
            print('Ранг матрицы равен 1')
        elif (A[1].count(0) == 3 and A[0].count(0) != 3 and A[2].count(0) != 3) or \
                (A[0].count(0) == 3 and A[1].count(0) != 3 and A[2].count(0) != 3) or \
                (A[2].count(0) == 3 and A[0].count(0) != 3 and A[1].count(0) != 3):
            print('Ранг матрицы равен 2')
        else:
